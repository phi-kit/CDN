...
document.addEventListener("DOMContentLoaded", function() {
  // Load the header
  loadComponent('https://cdn.jsdelivr.net/gh/phi-kit/CDN@main/content/html/_navigation.html', 'navigation-placeholder');

  // Lead the footer
  loadComponent('https://cdn.jsdelivr.net/gh/phi-kit/CDN@main/content/html/_footer.html', 'footer-placeholder');
});